...
A hipótese prioritária de menor atrito continua **EA MQL5 restrito a execução/relato**, sujeito à confirmação da corretora para ações à vista e automação. ProfitDLL permanece adaptador alternativo; API oficial direta permanece possibilidade futura. A decisão e os controles de risco continuam no ATLAS.
